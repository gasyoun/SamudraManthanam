...
function CompareStrDigits(Str1,Str2:string;ValueIfNoDigits:boolean):boolean;//���������� ������ ����� � �������
...
// ��������, ���:  Caption:= AddBracketsToNums('������,1�������.113 115','()');
// Caption='������,(1)�������.(113) (115)';
...
// ����������: RomanToArabic ������ -1, ���� �������� romanNumber ������� �� ���������� ������� (��������, MIXKIX �� �������� ������� �����).
 const
...
begin
 ...
 begin
  ...
  SetByteBit(PackedArr[ElmNum],7,True); // ��� ����, ����� ������ �� = #0
 end;
end;
