...
**W3 done (14-07-2026, [H919](https://github.com/gasyoun/Uprava/blob/main/handoffs/H919-Sonnet_SamudraManthanam_nkrya-wave3-sanskritisms-layer_14.07.26.md), Sonnet 5 `claude-sonnet-5`):** [`web/corpus_builder/sanskritisms/`](https://github.com/gasyoun/SamudraManthanam/blob/main/web/corpus_builder/sanskritisms/) shipped — the 6-condition stemmer + 9-rule disambiguator + capitalization rescue (thesis §3.3.1/§3.3.3), with the thesis's missing 271 MB OpenCorpora КРС dump substituted by `pymorphy3` (verified against the thesis's own loanword-collision worked examples). Two things the roadmap listed as inputs turned out not to be directly usable and are logged as deferred follow-ups in [`SPEC.md`](https://github.com/gasyoun/SamudraManthanam/blob/main/web/corpus_builder/sanskritisms/SPEC.md) §6 rather than force-fit: the 1.09M-pair `corpus_lexicon.jsonl`'s `ru` field is a phrase-level gloss, not a Cyrillic lemma list (needs an IAST/SLP1→Cyrillic transcription scheme that doesn't exist anywhere in the org — W3b); the thesis's own 354k-word dictionary was never committed to this repo at all. Lemma pool is therefore Sørensen's 9460 MBh-scoped names only. Gold-data floors (`pytest -m corpus`): MBh-3 ~69%/60% recall/precision vs `3_INDEX_oneword.txt`, Ram-3 ~56%/54% vs `Ramayana_names_clean_united.txt` — below the thesis's own 98% recall because the deeppavlov-tier residual disambiguation (~20% of multi-candidate cases) is intentionally not ported (flagged `needs_review` instead of guessed — W3c). Ran across all 123 verse sources with canonical JSONL (1 skipped, `devibhagavata-purana`, H558 gap): 34,134 lemma entries, committed under `nkrya-parallel/export/sanskritisms/`.
...
Handoffs: [H753](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H753-Sonnet_SamudraManthanam_nkrya-wave0-land-thesis-site_11.07.26.md) (W0), [H754](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H754-Opus_SamudraManthanam_nkrya-wave1-pilot-triple-export_11.07.26.md) (W1), [H759](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H759-Fable_SamudraManthanam_nkrya-wave2-sanskrit-3path-annotation-a41-section_12.07.26.md) (W2), [H919](https://github.com/gasyoun/Uprava/blob/main/handoffs/H919-Sonnet_SamudraManthanam_nkrya-wave3-sanskritisms-layer_14.07.26.md) (W3); W4–W5 handoffs are minted when their blockers clear. Human rows live in [Uprava/GTD_NEXT_ACTIONS.md](https://github.com/gasyoun/Uprava/blob/main/GTD_NEXT_ACTIONS.md). Paper: [A41](https://github.com/gasyoun/SamudraManthanam/blob/main/papers/A41_parallel_corpus_descriptor.md). Sibling roadmap (web platform, distinct workstream): [ROADMAP_2026_H2_DH_MOBILE.md](https://github.com/gasyoun/SamudraManthanam/blob/main/ROADMAP_2026_H2_DH_MOBILE.md).
