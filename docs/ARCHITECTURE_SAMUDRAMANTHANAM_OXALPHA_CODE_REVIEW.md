# SamudraManthanam OxAlpha code-review architecture

_Created: 26-08-2026 · Last updated: 26-08-2026_

## Components

1. Canonical [issue tracker](https://github.com/gasyoun/SamudraManthanam/blob/main/docs/agents/issue-tracker.md), [triage labels](https://github.com/gasyoun/SamudraManthanam/blob/main/docs/agents/triage-labels.md), and [domain rules](https://github.com/gasyoun/SamudraManthanam/blob/main/docs/agents/domain.md).
...
5. [Evidence ledger](https://github.com/gasyoun/SamudraManthanam/blob/main/docs/reviews/OXALPHA_RETROSPECTIVE_CODE_REVIEW_26-08-2026.md) preserving both axes, exclusions, and proof.
6. Fix lane admitting only proven P0/P1, one minimal regression-tested PR per defect.
7. Inactive [future-gate design](https://github.com/gasyoun/SamudraManthanam/blob/main/docs/OXALPHA_STATUS_GATE_DESIGN_2026.md).
