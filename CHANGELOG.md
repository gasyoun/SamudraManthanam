...
## [0.19.7] - 2026-08-07
### Added
- **Māyā-tantra glued-digit front-end + ingest (H2377, Grok 4.5 grok-4.5).** New --footnote-mode glued-digit|bracket|auto on ignatiev_book_to_canonical.py: page-local DBhP-style notes stripped before verse split; inline glued-digit linking; ToC ghost-chapter drop. Māyā registered: **12 ch / 343 RU verses / 148 comments**, HTML→JSONL round-trip **100%**, re-run stable. uto stays racket (Wave-A count lock). Design: [docs/MAYA_TANTRA_GLUED_DIGIT_MODE_H2377.md](https://github.com/gasyoun/SamudraManthanam/blob/main/docs/MAYA_TANTRA_GLUED_DIGIT_MODE_H2377.md). Corpus-manifest pin rebuilt.
